    ...
    public String scenicSpotSave(HttpServletRequest request, String id, @RequestParam("fileName") MultipartFile file){
        ...
        try {
            ...
            if(file != null && !file.isEmpty()){
                ...
                String path = Tools.URLDecoderString( Thread.currentThread().getContextClassLoader().getResource("").getPath().substring(0,Thread.currentThread().getContextClassLoader().getResource("").getPath().length()-16)
                		+"/src/main/resources/static/scenicSpot") ;
            ...
            if(entity.getSpotStar() == null||entity.getSpotStar() == 0) {
            	entity.setSpotStar(1);
            }
