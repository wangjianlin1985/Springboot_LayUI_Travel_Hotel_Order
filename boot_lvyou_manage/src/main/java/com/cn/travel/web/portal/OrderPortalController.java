...
public class OrderPortalController extends BaseController {
    ...
    public String tuiOrder(String id) throws Exception {
        Order order = orderService.findById(id);
        order.setState(3);
        orderService.update(order);
        return REDIRECT+"/myOrder";
    ...
    @RequestMapping("/tyOrder")
    public String tyOrder(String id) throws Exception {
        Order order = orderService.findById(id);
        order.setState(4);
        orderService.update(order);
        return REDIRECT+"/myOrder";
    ...
    @RequestMapping("/jjOrder")
    public String jjOrder(String id) throws Exception {
        Order order = orderService.findById(id);
        order.setState(5);
        orderService.update(order);
        return REDIRECT+"/myOrder";
